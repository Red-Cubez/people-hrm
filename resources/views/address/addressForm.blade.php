            ...
            <div class="col-sm-6">
                <input type="text" name="streetLine1" id="streetLine1" class="form-control" @if(isset($client->address) )
                 value="{{$client->address->streetLine1 }}" @elseif(isset($client) )
                     ...
                     value="{{$company->address->streetLine1 }}" @elseif(isset($editEmployeeModel->employeeProfile->streetLine1) )
                     value="{{$editEmployeeModel->employeeProfile->streetLine1 }}" @else placeholder="Enter Street Line 1" @endif >
            </div>
 </div>
 <div class="form-group">
            ...
            <div class="col-sm-6">
                <input type="text" name="streetLine2" id="streetLine2" class="form-control" @if(isset($client->address))
                 ...
                 value="{{$client->streetLine2 }}" @elseif(isset($company->address) )
                     value="{{$company->address->streetLine2 }}" @elseif(isset($editEmployeeModel->employeeProfile->streetLine2) )
                     value="{{$editEmployeeModel->employeeProfile->streetLine2 }}" @else placeholder="Enter Street Line 2" @endif >
            </div>
 </div>
  <div class="form-group">
            ...
            <div class="col-sm-6">
                <input type="text" name="country" id="country" class="form-control" @if(isset($client->address))
                 ...
                 value="{{$client->country }}" @elseif(isset($company->address) )
                     ...
                     value="{{$editEmployeeModel->employeeProfile->country }}" @else placeholder="Enter Country" @endif  >
            </div>
 </div>
 <div class="form-group">
            ...
            <div class="col-sm-6">
                <input type="text" name="stateProvince" id="stateProvince" class="form-control" @if(isset($client->address))
                 ...
                 value="{{$client->stateProvince }}" @elseif(isset($company->address) )
                     value="{{$company->address->stateProvince }}" @elseif(isset($editEmployeeModel->employeeProfile->stateProvince) )
                     value="{{$editEmployeeModel->employeeProfile->stateProvince }}" @else placeholder="State / Province" @endif >
            </div>
 </div>
